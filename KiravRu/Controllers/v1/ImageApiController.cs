...
namespace KiravRu.Controllers.v1
{
    ...
    public class ImageApiController : ControllerBase
    {
        ...
        public ImageApiController(IWebHostEnvironment hostingEnvironment)
        {
        ...
        public IActionResult FileBrowse()
        {
            ...
            return Ok(new { dirInfos = directoryList });
        }
        ...
        {
            if ((dir == null) || (!Directory.Exists(dir))) { return Ok(); }
            var directoryList = new List<DirectoryImage>();
        ...
        public IActionResult GetFiles(string dir)
        {
            ...
            return Ok(new { filesList = filesList });
        }
